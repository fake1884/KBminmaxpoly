...
%\]
%
%Als nächstes wird $Y$ nach $Y^{*}$ mittels Linksmultiplikation mit $Xi$ transformiert
%
%\begin{align*}
%\Upsilon^{-1/2} \times Y &=& \\
...
%
%
%und $X$ nach $X^{*}$ transformiert
%
%\[
%\Upsilon^{-1/2} \times X = ... = ... = X^{*}
%\]
%
%als nächstes wird die OLS-Regression durchgeführt und man erhält die Werte $\beta=(...,...)$ und $\sigma=...$.
...
%In diesem Abschnitt wird gescht, ob die verschiedenen Modelle um Regression durchzuführen sich signifikant unterscheiden.
%
...
In diesem Abschnitt werden Polynomregressionen mit verschiedenen Polynomgraden durchgeführt.
