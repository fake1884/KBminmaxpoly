...
Vergleicht man wieder die Regression mit Grad Eins und mit Grad Drei erhält man die Abbildung \ref{Bsp-KB-poly-hetero-AR}.
...
Das heißt, wir führen Regressionen mit einer Designmatrix $X$ von der Form $\tilde{x}_l = (1, x, x^2, x^3, x^4)$ und Grad Fünf und Sechs durch.
