...
\newcommand{\TestWert}{165.0847}% Wert der Teststatistik
...
Man sieht, dass die konstante Nullfunktion nicht ganz im Konfidenzband enthalten ist. Also kann man auch in diesem Fall die Nullhypothese verwerfen.
...
\begin{enumerate}
%\item Benutze gls um $\hat{\phi}$ zu bestimmen.
