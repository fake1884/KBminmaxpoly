...
ausgegangen, wobei $e \sim \mathscr{N}_{n}(0,I_n \sigma^2)$ war.  Es wurden für dieses Modell Konfidenzbänder mit verschiedenen Designmatritzen $X$ sowohl auf $\mathbb{R}^{n}$ als auch auf einem Intervall $A$ bestimmt.
